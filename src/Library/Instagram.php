...
class Instagram implements ExperimentsInterface
{
     ...
     *
     * @var \App\Library\Devices\DeviceInterface
     */
    public $device;
     ...
     *
     * @var \App\Library\Settings\StorageHandler|null
     */
    public $settings;
        ...
        array $storageConfig = [])
    {
        ...
        if (!self::$allowDangerousWebUsageAtMyOwnRisk && (!defined('PHP_SAPI') || PHP_SAPI !== 'cli')) {
            ...
            echo '<p><code>\App\Library\Instagram::$allowDangerousWebUsageAtMyOwnRisk = true;</code></p>'.PHP_EOL;
        ...
        if (!defined('PHP_VERSION_ID') || PHP_VERSION_ID < 50600) {
            throw new \App\Library\Exception\InternalException(
        ...
        foreach ($extensions as $ext) {
            if (!@extension_loaded($ext)) {
                throw new \App\Library\Exception\InternalException(sprintf(
     ...
     * @throws \App\Library\Exception\InstagramException
     *
     * @return \App\Library\Response\LoginResponse|null A login response if a
     *                                                   full (re-)login
     *                                                   happens, otherwise
     *                                                   `NULL` if an existing
     *                                                   session is resumed.
     ...
     * @throws \App\Library\Exception\InstagramException
     *
     * @return \App\Library\Response\LoginResponse|null
     *
        ...
        $appRefreshInterval = 1800)
    {
        ...
        if (!$this->isMaybeLoggedIn || $forceLogin) {
            ...
            } catch (\App\Library\Exception\InstagramException $e) {
     ...
     * @throws \App\Library\Exception\InstagramException
     *
     * @return \App\Library\Response\LoginResponse
     */
     ...
     * @throws \App\Library\Exception\InstagramException
     *
     * @return \App\Library\Response\TwoFactorLoginSMSResponse
     */
     ...
     * @throws \App\Library\Exception\InstagramException
     *
     * @return \App\Library\Response\UsersLookupResponse
     */
     ...
     * @throws \App\Library\Exception\InstagramException
     *
     * @return \App\Library\Response\RecoveryResponse
     */
        ...
        $username)
    {
        ...
        if (!$userLookup->getCanEmailReset()) {
            throw new \App\Library\Exception\InternalException('Email recovery is not available, since your account lacks a verified email address.');
        }
        ...
        $username)
    {
        ...
        if (!$userLookup->getHasValidPhone() || !$userLookup->getCanSmsReset()) {
            throw new \App\Library\Exception\InternalException('SMS recovery is not available, since your account lacks a verified phone number.');
        }
...
//            $this->internal->logResurrectAttribution();
            ...
            if ($isSessionExpired) {
                ...
                try {
                    $this->story->getReelsTrayFeed('cold_start');
                } catch (\App\Library\Exception\LoginRequiredException $e) {
     ...
     * @throws \App\Library\Exception\InstagramException
     *
     * @return \App\Library\Response\LogoutResponse
     *
     * @see Instagram::login()
     */
