...
use App\Library\Response\Model\Item;
...
class Utils
{
     ...
     *
     * \App\Library\Utils::$defaultTmpPath = '/home/example/foo/';
     */
        ...
        $location)
    {
        if (!$location instanceof Location) {
            throw new \InvalidArgumentException('The location must be an instance of \App\Library\Response\Model\Location.');
        }
     ...
     *
     * \App\Library\Utils::$ffprobeBin = '/home/exampleuser/ffmpeg/bin/ffprobe';
     *
