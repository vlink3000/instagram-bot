...
use App\Library\Exception\CheckpointRequiredException;
use App\Library\Exception\ConsentRequiredException;
use App\Library\Exception\FeedbackRequiredException;
use App\Library\Exception\InstagramException;
use App\Library\Exception\LoginRequiredException;
use App\Library\Exception\NetworkException;
use App\Library\Exception\SettingsException;
use App\Library\Exception\ThrottledException;
use App\Library\Exception\UploadFailedException;
use App\Library\Media\MediaDetails;
use App\Library\Media\Video\FFmpeg;
use App\Library\Media\Video\InstagramThumbnail;
use App\Library\Media\Video\VideoDetails;
use App\Library\Request;
use App\Library\Request\Metadata\Internal as InternalMetadata;
...
class Internal extends RequestCollection
{
     ...
     * @throws \App\Library\Exception\InstagramException
     * @throws \App\Library\Exception\UploadFailedException
     *
     * @return \App\Library\Response\ConfigureResponse
     *
     ...
     * @throws \InvalidArgumentException
     * @throws \App\Library\Exception\InstagramException
     * @throws \App\Library\Exception\UploadFailedException If the video upload fails.
     *
        ...
        array $externalMetadata = [])
    {
        ...
        try {
            /** @var \App\Library\Response\ConfigureResponse $configure */
     ...
     * @param InternalMetadata $internalMetadata Internal library-generated metadata object.
     *
     * @throws \App\Library\Exception\InstagramException If the request fails.
     *
     * @return \App\Library\Response\UploadJobVideoResponse
     */
     ...
     *
     * @throws \App\Library\Exception\SettingsException
     */
     ...
     * @throws \App\Library\Exception\InstagramException
     *
     * @return \App\Library\Response\SyncResponse
     */
     ...
     * @throws \App\Library\Exception\InstagramException
     *
     * @return \App\Library\Response\LauncherSyncResponse
     */
     ...
     * @throws \App\Library\Exception\InstagramException
     *
     * @return \App\Library\Response\CapabilitiesDecisionsResponse
     */
     ...
     * @throws \App\Library\Exception\InstagramException
     *
     * @return \App\Library\Response\GenericResponse
     */
     ...
     * @throws \App\Library\Exception\InstagramException
     *
     * @return \App\Library\Response\MsisdnHeaderResponse
     */
     ...
     * @throws \App\Library\Exception\InstagramException
     *
     * @return \App\Library\Response\TokenResultResponse
     */
     ...
     * @throws \App\Library\Exception\InstagramException
     *
     * @return \App\Library\Response\MegaphoneLogResponse
     */
     ...
     * @throws \App\Library\Exception\InstagramException
     *
     * @return \App\Library\Response\FacebookHiddenEntitiesResponse
     */
     ...
     * @throws \App\Library\Exception\InstagramException
     *
     * @return \App\Library\Response\FacebookOTAResponse
     */
     ...
     * @throws \App\Library\Exception\InstagramException
     *
     * @return \App\Library\Response\LoomFetchConfigResponse
     *
     ...
     * @throws \App\Library\Exception\InstagramException
     *
     * @return \App\Library\Response\ProfileNoticeResponse
     */
     ...
     * @throws \App\Library\Exception\InstagramException
     *
     * @return \App\Library\Response\FetchQPDataResponse
     */
     ...
     * @throws \App\Library\Exception\InstagramException
     *
     * @return \App\Library\Response\ArlinkDownloadInfoResponse
     */
     ...
     * @throws \App\Library\Exception\InstagramException
     *
     * @return \App\Library\Response\QPCooldownsResponse
     */
     ...
     * @throws \App\Library\Exception\InstagramException
     *
     * @return \App\Library\Response\MediaSeenResponse
     *
        ...
        $module = 'feed_timeline')
    {
        ...
        foreach ($items as $item) {
            if (!$item instanceof Response\Model\Item) {
                throw new \InvalidArgumentException(
                    'All story items must be instances of \App\Library\Response\Model\Item.'
                );
            }
...
//            ->addParam('live_vod', 0)
     ...
     * @throws \App\Library\Exception\InstagramException
     *
     * @return \App\Library\Response\UploadPhotoResponse
     */
     ...
     * @throws \App\Library\Exception\InstagramException
     *
     * @return \App\Library\Response\UploadVideoResponse
     */
